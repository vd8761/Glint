                  ...
                  <div className="block md:hidden space-y-4">
                    {filteredPrograms.map((p) => (
                      <div key={p.id} className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm space-y-4">
                        <div className="space-y-1">
                          <h3 className="font-bold text-slate-950 text-sm capitalize">{p.name}</h3>
                        ...
                        <div className="pt-2 border-t border-slate-100 text-xs flex justify-between items-center">
                          ...
                          <div className="flex gap-2.5">
                            <button
                              onClick={() => startEditProgram(p)}
                              className="p-1.5 rounded-lg border border-slate-200 text-slate-500 hover:text-slate-900 transition-all"
                              title="Edit Program"
                            >
                            ...
                            <button
                              onClick={() => handleDeleteProgram(p.id, p.name)}
                              className="p-1.5 rounded-lg border border-red-100 text-red-500 hover:text-red-700 transition-all"
